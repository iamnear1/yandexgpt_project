...
Обращай внимание только на правильность формул и математическую логику и корректность кода, а не на стилистические аспекты (например опечатки и тд). 
...
Если часть работы - код, и там встречается понятное обозначение из контекста, но переменная/функция не объявлена — это сделано выше, и следовательно не ошибка. 
